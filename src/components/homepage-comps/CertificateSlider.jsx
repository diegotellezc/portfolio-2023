...
const CertificateSlider = ({ certificates }) => {
    ...
    return (
        <section name='Education' className='relative w-full h-screen text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <Slider {...settings} className="grid w-[90%] lg:w-full mx-auto">
                    ...
                    <div key={index} className="p-4">
                        <img src={certificate.image} alt={certificate.title} className="mx-auto w-full h-[200px] lg:h-[220px] rounded-md object-contain" />
                    </div>
                ))}
                </Slider>
            </div>

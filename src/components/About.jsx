...
const About = () => {
    return (
        <section name="about" className='relative w-full max-w-[1200px] mx-auto p-6 flex flex-col gap-4 mt-[300px] mb-[90px] lg:px-24'>
            <div className='flex flex-row gap-10'>
                ...
                <div className='lex flex-col justify-center text-white text-lg text-justify'>
                    ...
                    <p className="mb-4 py-6">Hey! I live in Bogotá and I'm Professional in Audiovisual Media with more than 7 years of experience as a video editor. However, I felt that I had the potential for more, so my intellectual curiosity led me to enter into the world of programming.
                    </p>
